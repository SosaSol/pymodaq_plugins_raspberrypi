...
class ServoWrapper:
    ...
    def __init__(self, pin: int):
        try:
            ...
            self.current_angle = 90.0  # Default position is the neutral position (90 degrees)
...
class DAQ_Move_Servo(DAQ_Move_base):
    ...
    _axis_names = ['Servo']
    _controller_units: Union[str, list] = "deg"
    ...
    params = [
        ...
        {"title": "Angle:", "name": "angle", "type": "float", "value": 90.0, "min": 0.0, "max": 180.0, "step": 1.0},
    ...
    def ini_stage(self, controller=None):
        ...
        try:
            self.controller = ServoWrapper(pin=gpio_pin)  # Initialize the servo
    ...
    def move_home(self):
        ...
        try:
            self.controller.move_to_angle(0.0)
            self.emit_status(ThreadCommand("Update_Status", ["Servo moved to home position (0.00 degrees)."]))
        except RuntimeError as e:
